...
create table publicacion_articulo(
    ...
    CONSTRAINT publicacion_articulo_articulo_fk FOREIGN KEY (articulo_id) 
    REFERENCES articulo(articulo_id),
    CONSTRAINT publicacion_articulo_publicacion_fk FOREIGN KEY (publicacion_id) 
...
create table publicacion_suscriptor(
    ...
    CONSTRAINT publicacion_suscriptor_suscriptor_fk FOREIGN KEY (suscriptor_id) 
    REFERENCES suscriptor(suscriptor_id),
    CONSTRAINT publicacion_suscriptor_publicacion_fk FOREIGN KEY (publicacion_id) 
    REFERENCES publicacion(publicacion_id)
);
...
create table revisado_articulo(
    ...
    CONSTRAINT revisado_articulo_revisor_id_fk FOREIGN KEY (revisor_id) 
    REFERENCES revisor(empleado_id),
    CONSTRAINT revisado_articulo_articulo_id_fk FOREIGN KEY (articulo_id) 
    REFERENCES articulo(articulo_id)    
);
